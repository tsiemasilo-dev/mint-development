...
- [Home card period P&L fix](home-card-period-pnl.md) — 5D/M use cash-adjusted, non-trading-day-aware anchor; YTD/ALL use cost-basis (transaction_id IS NOT NULL holdings + buffer).
