...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-400 via-purple-200 to-white px-4 pb-[calc(6rem+env(safe-area-inset-bottom))] pt-12 text-slate-900 md:px-8 md:pt-14">
