  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="rounded-lg bg-zinc-900 px-3 py-2 text-white shadow-lg">
        ...
        <div className="text-sm font-semibold">{formatPct(v)}</div>
      </div>
    );
  }
  return null;
...
export default function StrategyReturnChart() {
  ...
  return (
    <div className="flex min-h-screen w-full max-w-5xl items-center justify-center p-6 lg:p-8">
      <Card className="w-full lg:max-w-4xl">
        <CardHeader className="min-h-auto border-0 pb-4 pt-6">
