        ...
        <div className="mt-3 bg-emerald-50 border border-emerald-200 rounded-2xl p-5 space-y-4">
          <div className="text-center">
            ...
            <p className="text-xs text-slate-500">
              {firstName} has been notified at {recipientEmail.trim().toLowerCase()}. Share this code with them too — they'll need it + their SA ID to claim on Mint. Expires at {formatExpiry(expiresAt)}.
            </p>
          </div>
